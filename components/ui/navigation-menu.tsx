...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-primary-foreground hover:text-white focus:bg-primary-foreground focus:text-white focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-primary-foreground data-[state=open]:bg-primary-foreground data-[state=open]:text-white',
);
