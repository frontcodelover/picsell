...
const Questions = () => {
  return (
		<ProfileLayout>
			...
			<AlertDescription>Si vous ne trouvez pas la réponse à votre question consultez les <Link href="/cgv" className='font-bold underline'>Conditions générales de vente</Link> ou contactez-nous.</AlertDescription>
				</Alert>
  ...
  <AccordionItem value="item-2">
    ...
    <AccordionContent>
      La plateforme prélève une commission sur chaque vente. Les détails des frais seront affichés au moment de l'inscription.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-3">
    ...
    <AccordionContent>
      Vous pouvez vendre des impressions de tout type, à l'exception des photos de nu ou à caractère pornographique.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-4">
    ...
    <AccordionContent>
      Le photographe est entièrement responsable de l'emballage et de l'expédition des impressions.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-5">
    ...
    <AccordionContent>
      Une fois la commande passée, le photographe a 10 jours pour l'envoyer. L'acheteur dispose de 15 jours pour valider la réception.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-6">
    ...
    <AccordionContent>
      Les paiements sont gérés via Stripe, garantissant des transactions sécurisées pour les photographes et les acheteurs.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-7">
    ...
    <AccordionContent>
      Le client doit contacter directement le photographe pour discuter des solutions possibles.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-8">
    ...
    <AccordionContent>
      Oui, les photographes sont libres de fixer les prix qu'ils souhaitent pour leurs impressions.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-9">
    ...
    <AccordionContent>
      Chaque photographe doit fournir un numéro de suivi pour que les acheteurs puissent suivre leurs commandes.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-10">
    ...
    <AccordionContent>
      Oui, en cas de problème, vous pouvez contacter notre support à l'adresse email (à venir).
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="item-11">
    ...
    <AccordionContent>
      Si vous n'avez pas reçu votre commande, veuillez contacter directement le vendeur.
    </AccordionContent>
  </AccordionItem>
